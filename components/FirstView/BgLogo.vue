<template>
  <div class="logo">
    ...
    <transition>
      <svg viewBox="0 0 512 512" class="logo__inner-circle" v-show="logo">
        <g>
          ...
          <polygon
            points="113.934,42.425 155.9,115.134 184.067,98.875 142.084,26.167 	"
          ></polygon>
          <polygon
            points="327.95,413.125 369.934,485.833 398.084,469.575 356.116,396.859 	"
          ></polygon>
          <polygon
            points="115.134,155.892 42.434,113.916 26.184,142.084 98.884,184.05 	"
          ></polygon>
          <polygon
            points="396.867,356.1 469.583,398.084 485.834,369.916 413.134,327.934 	"
          ></polygon>
          <polygon
            points="83.95,239.742 0,239.734 0,272.258 83.95,272.258 	"
          ></polygon>
          <rect x="428.05" y="239.734" width="83.95" height="32.525"></rect>
          <polygon
            points="98.884,327.95 26.167,369.916 42.434,398.084 115.134,356.1 	"
          ></polygon>
          <polygon
            points="413.134,184.05 485.834,142.084 469.583,113.916 396.867,155.892 	"
          ></polygon>
          <polygon
            points="113.917,469.575 142.084,485.833 184.05,413.125 155.9,396.866 	"
          ></polygon>
          <polygon
            points="398.084,42.425 369.917,26.167 327.934,98.875 356.1,115.134 	"
          ></polygon>
        </g>
      </svg>
    </transition>
    ...
    >
      ...
      <!-- 右 -->
      <polyline
        points="317, 210 325.5,205  375, 205 405, 215"
        stroke-width=".7"
      />
      <circle cx="406" cy="215.5" r="1.4" />
      <polyline
        points="295,240 314, 230 390,230 400,225 430, 225  460, 225 495, 240"
      />
    ...
    <svg viewBox="0 0 1400 751" class="logo__bg">
      <g transform="translate(0.000000,751.000000) scale(0.100000,-0.100000)">
        <path
          d="M4619 5989 c-16 -16 -20 -29 -16 -54 5 -31 -5 -42 -231 -268 l-237
        ...
        />
        <path
          d="M10632 5468 l-187 -188 -732 0 c-657 0 -733 2 -741 16 -6 10 -19 14
      ...
      <polyline
        points="1400, 303 1275, 303"
        fill="none"
        stroke="#f5f5f5"
        stroke-width="1"
      />
      <polyline
        points="1400, 200 1300, 200 1200, 150 1110, 150 1050 , 150 1000,100 830,100 790,140"
        fill="none"
        stroke="#f1f1f1"
        stroke-width="4"
      />
      ...
      <polyline
        points="1050 , 150 980,200 920,200 830, 300 780,300 760,320"
        fill="none"
        stroke="#f5f5f5"
        stroke-width="2"
      />
...
.logo {
  ...
  &__circle {
    ...
    &--m {
      ...
      stroke-opacity: 0;
      stroke-width: 12;
      animation: circle-m 1s ease forwards 0.8s;
    }
    &--mb {
      //太
      fill: none;
